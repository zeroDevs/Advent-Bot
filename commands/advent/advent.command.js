...
exports.run = async (client, message, args) => {
  ...
  client.sendEmbed(
    client,
    {
      ...
      fields: [
        [':clipboard: About AoC', 'Find out more [here](https://adventofcode.com/2019/about)', true],
        [':calendar:  Todays Challenge', 'Check it out [here](https://adventofcode.com/2019)', true],
        [':eye: View Solutions', 'ZTM solutions [here](https://aoc/zerotomastery.io/solutions)', true],
        [':medal: View Leaderboard', 'How do your [rank](https://aoc/zerotomastery.io/leaderboard)?', true],
        [blank, blank],
        [':white_check_mark:   Sumbmit Your Solutions   :white_check_mark:  ', '=-=-=-=-=-=-=-=-=-=-==-=-=-=-=', false],
        [':link: **Submit Your Solution**', ' You can submit your solution over [here](https://aoc/zerotomastery.io/submit)'],
        [blank, blank],
